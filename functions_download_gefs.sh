...
timeout 300 perl $HOME_SCRIPTS/get_inv.pl "${url_control}.idx" | \
        grep -E ":((TMP|DPT|TMAX|TMIN):2 m above ground|(TMP|HGT|RH):(5|10|20|50|100|200|250|300|400|500|600|700|850|900|925|950|975|1000) mb|(UGRD|VGRD):10 m above ground|(CAPE|CIN|GUST):surface|PRMSL|APCP:surface:0-(*.)|TCDC:entire atmosphere|SNOD)" | \
