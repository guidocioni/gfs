...
def main():
    ...
    dset = read_dataset(variables=['prate', 'csnow', 'cicep', 'cfrzr',
                                    'crain', 'tcc', 'prmsl'],
    ...
    cmap_clouds = truncate_colormap(plt.get_cmap('Greys'), 0.1, 0.6)
...
def plot_files(dss, **args):
    ...
    for time_sel in dss.time:
        ...
        cs_clouds_low = args['ax'].contourf(args['x'], args['y'], data['tcc'],
        ...
        an_var = annotation(args['ax'], 'Clouds (grey-low), rain, snow and MSLP',
        ...
        if first:
            if projection == "euratl": 
                ...
                x_cbar_0, y_cbar_0, x_cbar_size, y_cbar_size     = 0.17, 0.12, 0.32, 0.02
                x_cbar2_0, y_cbar2_0, x_cbar2_size, y_cbar2_size = 0.55, 0.12, 0.32, 0.02
            elif projection == "it":
                x_cbar_0, y_cbar_0, x_cbar_size, y_cbar_size     = 0.18, 0.1, 0.3, 0.02
                x_cbar2_0, y_cbar2_0, x_cbar2_size, y_cbar2_size = 0.55, 0.1, 0.3, 0.02
            else:
                x_cbar_0, y_cbar_0, x_cbar_size, y_cbar_size     = 0.15, 0.07, 0.35, 0.02
                x_cbar2_0, y_cbar2_0, x_cbar2_size, y_cbar2_size = 0.55, 0.07, 0.35, 0.02
        ...
        remove_collections([c, cs_rain, cs_snow, cs_clouds_low,
